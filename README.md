...
- Ensure stocks.txt has valid symbols

**"Insufficient data" errors?**
- Stock may be newly listed
- Try increasing data period in `yf.download()`

**MACD showing all "Hold"?**
- Normal during non-volatile markets
- Bollinger filter may be excluding stocks
- Check console output for full Bollinger results

**GitHub Actions not running?**
- Verify cron syntax
- Check repository is not disabled
